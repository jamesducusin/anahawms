...
<head>
    <?php echo view('hotel/inc/head-css', array('title' => 'Detail')); ?>
...
<body>
    ...
    <section class="pt-0 ratio2_3 zoom-gallery overlay-hover">
        <div class="container-fluid p-0">
            <div class="row m-0">
                <?php $images = explode(";", $details['images']); ?>
                <div class="col-md-6 p-0">
                    <a href="<?= site_url('assets/hotelresto/images/hotel/room/') . $images[0] ?>">
                        <img src="<?= site_url('assets/hotelresto/images/hotel/room/') . $images[0] ?>" class="img-fluid blur-up lazyload bg-img" alt="">
                    </a>
                </div>
                <?php $j = 1;
                for ($i = 0; $i < 4; $i += 2) : ?>
                    <div class="col-md-3 col-6 p-0">
                        <?php for ($j; $j <= $i + 2; $j++) : ?>
                            <a href="<?= site_url('assets/hotelresto/images/hotel/room/') . $images[$j] ?>">
                                <img src="<?= site_url('assets/hotelresto/images/hotel/room/') . $images[$j] ?>" class="img-fluid blur-up lazyload bg-img" alt="">
                            </a>
                        <?php endfor; ?>
                    </div>
                <?php endfor; ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="hotel_title_section">
                        <div class="hotel-name">
                            <div class="left-part">
                                ...
                                <div class="top">
                                    <h5>@Anahaw Island View Resort</h5>
                                    <div class="rating mb-1">

                                        <?= isset($rateAvg[0]['rating']) ? generateStar($rateAvg[0]['rating']) :  generateStar(0) ?>
                                        <small><?= isset($reviews[0]['rateCount']) ? count($reviews) : 0; ?> reviews</small>
                                    </div>
                                </div>
                            ...
                            <div class="right-part">
                                <h2 class="price">Php <?= isset($details['price']) ? $details['price'] : ""; ?> <span>/ per night</span></h2>
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="description-section tab-section">
                        <div class="menu-top menu-up">
                            <ul class="nav nav-tabs" id="top-tab" role="tablist">
                                <li class="nav-item"><a data-bs-toggle="tab" class="nav-link active" href="#overview">overview</a></li>
                                ...
                                <li class="nav-item"><a data-bs-toggle="tab" class="nav-link" href="#photos">photos</a>
                                </li>
                            ...
                            <div class="description-details tab-content" id="top-tabContent">
                                <div class="menu-part tab-pane fade show active" id="overview">
                                    <table class="rooms-box">
                                        <tr>
                                            <td>
                                                <h6 class="room-title"><?= $details['name'] ?> Room</h6>
                                                <a href="#">
                                                    <img src="<?= site_url('assets/hotelresto/images/hotel/room/') . $details['image'] ?>" class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </td>
                                            <td>
                                                <div class="room-detail">
                                                    <div class="row">
                                                        <div class="col-6 p-0">
                                                            ...
                                                            <div class="facility-detail">
                                                                <ul>
                                                                    <li><img src="<?= site_url('assets/hotelresto') ?>/images/icon/tour/bed.png" class="img-fluid blur-up lazyload" alt="">
                                                                        king/twin
                                                                    </li>
                                                                    <li><img src="<?= site_url('assets/hotelresto') ?>/images/icon/hotel/shower.png" class="img-fluid blur-up lazyload" alt="">
                                                                        Shower
                                                                    </li>
                                                                    <li><img src="<?= site_url('assets/hotelresto') ?>/images/icon/hotel/television.png" class="img-fluid blur-up lazyload" alt="">
                                                                        LCD TV</li>
                                                                    <li><img src="<?= site_url('assets/hotelresto') ?>/images/icon/hotel/couch.png" class="img-fluid blur-up lazyload" alt="">
                                                                        couch
                                                                    </li>
                                                                </ul>
                                                            </div>
                                ...
                                <div class="menu-part tab-pane fade photos" id="photos">

                                    <div class="portfolio-section creative-section  ratio_square"">
                                        <div class="container">
                                            <div class="filter-button-group">
                                                <ul>
                                                    ...
                                                    <?php foreach ($photos as $photo) : ?>
                                                        ...
                                                        <li data-filter=".<?= $photo['category'] ?>"><?= $photo['category'] ?></li>

                                                    <?php endforeach; ?>
                                                </ul>
                                            </div>
                                            <div class="row m-0 content grid zoom-gallery">
                                                <?php foreach ($photos as $photo) :
                                                    $images = explode(";", $photo['images']);
                                                    foreach ($images as $image) : ?>
                                                        <div class="<?= $photo['category'] ?> grid-item wow zoomIn p-0 col-lg-2 col-md-4 col-6">
                                                            <div class="overlay">
                                                                <div class="portfolio-image">
                                                                    <a href="<?= site_url('assets/hotelresto') ?>/images/hotel/room/<?= $image ?>">
                                                                        <img src="<?= site_url('assets/hotelresto') ?>/images/hotel/room/<?= $image ?>" alt="" class="img-fluid blur-up lazyload bg-img">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <?php foreach ($facility_types as $type) : ?>
                                            <div class="col-xl-3 col-6">
                                                ...
                                                <h6><img src="<?= site_url('assets/hotelresto') ?>/images/icon/hotel/<?= $type['image'] ?>" class="img-fluid blur-up lazyload" alt=""> <?= $type['name'] ?>
                                                </h6>

                                                <ul>
                                                    <?php foreach ($facilities as $facility) :
                                                        if ($facility['type_id'] == $type['id']) : ?>

                                                            <li><i class="fas fa-check"></i> <?= $facility['name'] ?></li>
                                                    <?php endif;
                                                    endforeach; ?>
                                ...
                                <div class="menu-part tab-pane fade map" id="location">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3880.934442634439!2d121.15854037592841!3d13.416385004969058!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bceece975a1a9d%3A0xe9752d2738d90944!2sAnahaw%20Island%20View%20Resort!5e0!3m2!1sen!2sph!4v1695872617512!5m2!1sen!2sph" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                                <div class="menu-part tab-pane fade review" id="review" style="max-height: 600px;overflow-y: scroll; border: 1px solid #ccc; ">
                                    <?php foreach ($reviews as $review) : ?>
                                        <div class="review-box">
                                            <div class="rating">
                                                <?= generateStar($review['rate']) ?>
                                                <span><?= $review['content'] ?></span>
                                            </div>
                                            <h6>by <?= $review['pname'] . "," . $review['created_at'] ?></h6>
                                            <p><?= $review['comment'] ?>
                                            </p>
                                        </div>
                                    <?php endforeach; ?>
                    ...
                    <div class="mt-4">
                        <H5>Other rooms <i class="fas fa-arrows-alt-h d-md-none"></i></H5>
                    </div>
                    <div class="special-section related-box ratio3_2  grid-box">
                        <div class="slide-3 no-arrow">
                            ...
                            <div>
                                <div class="special-box p-0" style="<?= $room['status'] == 3 ? "color: #6c757d; 
        opacity: 0.6;   
        pointer-events: none;" : ""?>">
                                    <div class="special-img">
                                        <a href="#">
                                            <img src="<?= site_url('assets/hotelresto/images/hotel/room/').$room['image'] ?>" class="img-fluid blur-up lazyload bg-img" alt="">
                                        </a>
                                        <div class="top-icon">
                                    ...
                                    <div class="special-content">
                                        <a href="#">
                                            <h5><?=$room['name']?> Room <span><i class="fas fa-map-marker-alt"></i> Calapan</span>
                                            </h5>
                                        </a>
                                        <p>
                                            <?=$room['description']?>
                                        ...
                                        <div class="bottom-section">
                                            ...
                                            <div class="price">
                                                ...
                                                <div class="facility-detail">
                                                <?php for($i = 0; $i < 2; $i++):
                                                        echo "<span class='text-truncate'>" . $amenities[$i] . "</span>";
                                                    endfor; ?>
                                                    <span>..</span>
                                                </div>
                                            </div>
                ...
                <div class="col-xl-3 col-lg-4" id="booking">
                    <div class="sticky-cls-top">
                        <div class="single-sidebar">
                            <div class="selection-section">
                                <div class="overlay-map">
                                    <img src="http://themes.pixelstrap.com/rica/assets/images/map-image.svg" class="img-fluid blur-up lazyload" alt="">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3880.934442634439!2d121.15854037592841!3d13.416385004969058!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bceece975a1a9d%3A0xe9752d2738d90944!2sAnahaw%20Island%20View%20Resort!5e0!3m2!1sen!2sph!4v1695872617512!5m2!1sen!2sph" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    <h6>view on map</h6>
                                </div>
                                <div class="price-part">
                                ...
                                <div class="book-btn-section">
                                    ...
                                    <div class="rooms-section">
                                        <input type="text" class="form-control open-select" placeholder="rooms & guests">
                        ...
                        <div class="single-sidebar">
                            ...
                            <p class="address"> <i class="fas fa-map-marker-alt"></i> <?=$contacts[0]['location']?>
                            </p>
                            <p><i class="fas fa-phone-alt"></i>  <?=$contacts[0]['phone']?></p>
                            <a href="#">
                                <p><i class="fas fa-envelope"></i>  <?=$contacts[0]['email']?></p>
                            </a>
                            <div class="social-box">
                                <ul>
                            ...
                            <ul class="weather-sec">
                                ...
                                <li>
                                    ...
                                    <svg viewBox="0 0 512.00038 512" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="m326.753906 125.617188c4.199219 0 7.597656-3.402344 7.597656-7.597657v-6.691406c0-4.195313-3.398437-7.597656-7.597656-7.597656-4.199218 0-7.597656 3.402343-7.597656 7.597656v6.691406c0 4.195313 3.398438 7.597657 7.597656 7.597657zm0 0" />
                                        <path d="m373.53125 125.617188c4.199219 0 7.601562-3.402344 7.601562-7.597657v-6.691406c0-4.195313-3.402343-7.597656-7.601562-7.597656s-7.597656 3.402343-7.597656 7.597656v6.691406c0 4.195313 3.398437 7.597657 7.597656 7.597657zm0 0" />
                                        <path d="m344.234375 162.410156h16.210937c4.195313 0 7.597657-3.402344 7.597657-7.601562 0-4.195313-3.402344-7.597656-7.597657-7.597656h-16.210937c-4.199219 0-7.601563 3.402343-7.601563 7.597656 0 4.199218 3.402344 7.601562 7.601563 7.601562zm0 0" />
                                    </svg>
                                    <h6>25 °C</h6>
                                </li>
                                <li>
    ...
    <div class="book-panel">
        <button onclick="window.location.href='hotel-booking.html';" type="button" class="btn bottom-btn theme-color">book now</button>
