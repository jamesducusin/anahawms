...
<head>
    <?= view('admin/inc/head-css', array('title' => 'Walkthrough Booking')); ?>

    <link rel="stylesheet" href="<?= site_url('assets/admin') ?>/plugins/owlcarousel/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= site_url('assets/admin') ?>/plugins/owlcarousel/owl.theme.default.min.css">
...
<body>
        ...
        <div class="header">
            ...
            <div class="header-left border-0 ">
                <a href="index.html" class="logo">
                    <img src="<?= site_url('assets/auth/images') ?>/logo.ico" alt="">
                </a>
                <a href="index.html" class="logo-small">
                    <img src="<?= site_url('assets/admin') ?>/img/logo-small.png" alt="">
                </a>
            </div>
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item">
                    <div class="top-nav-search">
                        ...
                        <form action="#">
                            ...
                            <a class="btn" id="searchdiv"><img src="<?= site_url('assets/admin') ?>/img/icons/search.svg" alt="img"></a>
                        </form>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                        <img src="<?= site_url('assets/admin') ?>/img/flags/us1.png" alt="" height="20">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= site_url('assets/admin') ?>/img/flags/us.png" alt="" height="16"> English
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= site_url('assets/admin') ?>/img/flags/fr.png" alt="" height="16"> French
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= site_url('assets/admin') ?>/img/flags/es.png" alt="" height="16"> Spanish
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= site_url('assets/admin') ?>/img/flags/de.png" alt="" height="16"> German
                        </a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <img src="<?= site_url('assets/admin') ?>/img/icons/notification-bing.svg" alt="img"> <span class="badge rounded-pill">4</span>
                    </a>
                            ...
                            <ul class="notification-list">
                                    ...
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="<?= site_url('assets/admin') ?>/img/profiles/avatar-02.jpg">
                                            </span>
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="<?= site_url('assets/admin') ?>/img/profiles/avatar-03.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="<?= site_url('assets/admin') ?>/img/profiles/avatar-06.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="<?= site_url('assets/admin') ?>/img/profiles/avatar-17.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="<?= site_url('assets/admin') ?>/img/profiles/avatar-13.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                        <span class="user-img"><img src="<?= site_url('assets/admin') ?>/img/profiles/avator1.jpg" alt="">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        <div class="profilename">
                            ...
                            <hr class="m-0">
                            <a class="dropdown-item logout pb-0" href="signin.html"><img src="<?= site_url('assets/admin') ?>/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
                        </div>
                    </div>
                </li>
            </ul>
                    ...
                    <div class="col-lg-8 col-sm-12 tabs_wrapper">
                        <div class="page-header ">
                            <div class="page-title">
                                <h4>Room packages</h4>
                                <h6>Manage walkthrough booking</h6>
                            </div>
                        </div>
                        <ul class=" tabs owl-carousel owl-theme owl-product  border-0 ">
                            <li class="active" id="fruits">
                                <div class="product-details">
                                    <img src="<?= site_url('assets/admin') ?>/img/icons/all.png" alt="img">
                                    <h6>all</h6>
                                </div>
                            </li>
                            <li id="headphone">
                                <div class="product-details ">
                                    <img src="<?= site_url('assets/admin') ?>/img/icons/deluxe.jpg" alt="img">
                                    <h6>Deluxe Room</h6>
                                </div>
                            </li>
                            <li id="computer">
                                <a class="product-details">
                                    <img src="<?= site_url('assets/admin') ?>/img/icons/poolside.jpg" alt="img">
                                    <h6>Poolside</h6>
                                </a>
                            </li>
                            <li id="Accessories">
                                <div class="product-details">
                                    <img src="<?= site_url('assets/admin') ?>/img/icons/traveller.jpg" alt="img">
                                    <h6>Traveller Room</h6>
                                </div>
                            </li>
                            <li id="Shoes">
                                <a class="product-details">
                                    <img src="<?= site_url('assets/admin') ?>/img/icons/dormitory.jpg" alt="img">
                                    <h6>Dormitory Room</h6>
                                </a>
                            </li>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill active">
                                            ...
                                            <div class="productsetcontent">
                                                ...
                                                <h4 class="text-danger">&#x20B1; 1250.00</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-sm-12 ">
                        <div class="order-list">
                            ...
                            <div class="actionproducts">
                                <ul>
                                    <li>
                                        <a href="javascript:void(0);" class="deletebg confirm-text"><img src="<?= site_url('assets/admin') ?>/img/icons/delete-2.svg" alt="img"></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false" class="dropset">
                                            <img src="<?= site_url('assets/admin') ?>/img/icons/ellipise1.svg" alt="img">
                                        </a>
                        ...
                        <div class="card card-order">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="product-table">
                                    <ul class="product-lists">
                                        <li>
                                            <div class="productimg">
                                                ...
                                                <div class="productcontet">
                                                    <h4>Deluxe
                                                        <a href="javascript:void(0);" class="ms-2" data-bs-toggle="modal" data-bs-target="#edit"><img src="<?= site_url('assets/admin') ?>/img/icons/edit-5.svg" alt="img"></a>
                                                    </h4>
                                        ...
                                        <li>3000.00 </li>
                                        <li><a class="confirm-text" href="javascript:void(0);"><img src="<?= site_url('assets/admin') ?>/img/icons/delete-2.svg" alt="img"></a></li>
                                    </ul>
                            ...
                            <div class="card-body pt-0 pb-2">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0);" class="paymentmethod">
                                                <img src="<?= site_url('assets/admin') ?>/img/icons/cash.svg" alt="img" class="me-2">
                                                Cash
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="paymentmethod">
                                                <img src="<?= site_url('assets/admin') ?>/img/icons/scan.svg" alt="img" class="me-2">
                                                Scan Gcash
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" class="paymentmethod">
                                                <img src="<?= site_url('assets/admin') ?>/img/icons/debitcard.svg" alt="img" class="me-2">
                                                Others
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="btn-pos">
                                    <ul>
                                        <li>
                                            <a class="btn"><img src="<?= site_url('assets/admin') ?>/img/icons/pause1.svg" alt="img" class="me-1">Hold</a>
                                        </li>
                                        <li>
                                            <a class="btn"><img src="<?= site_url('assets/admin') ?>/img/icons/edit-6.svg" alt="img" class="me-1">Quotation</a>
                                        </li>
                                        <li>
                                            <a class="btn"><img src="<?= site_url('assets/admin') ?>/img/icons/trash12.svg" alt="img" class="me-1">Void</a>
                                        </li>
                                        <li>
                                            <a class="btn"><img src="<?= site_url('assets/admin') ?>/img/icons/wallet1.svg" alt="img" class="me-1">Payment</a>
                                        </li>
                                        <li>
                                            <a class="btn" data-bs-toggle="modal" data-bs-target="#recents"><img src="<?= site_url('assets/admin') ?>/img/icons/transcation.svg" alt="img" class="me-1"> Transaction</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    <div class="calculator-set">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="btn btn-closes"><img src="<?= site_url('assets/admin') ?>/img/icons/close-circle.svg" alt="img"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">0</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="btn btn-reverse"><img src="<?= site_url('assets/admin') ?>/img/icons/reverse.svg" alt="img"></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="delete-order">
                        <img src="<?= site_url('assets/admin') ?>/img/icons/close-circle1.svg" alt="img">
                    </div>
    ...
    <?= $this->include('admin/inc/end-script'); ?>
