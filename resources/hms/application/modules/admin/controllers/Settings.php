...
class Settings extends Admin_Controller {
	...
	function index()
	{
		...
		$fonts			=	json_decode(file_get_contents('https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyCmvcRx-h8aQxpKJ8-y3otFEiQH_7ylz5U', false, stream_context_create($arrContextOptions)));
