...
*/
class Translator extends Admin_Controller {
	...
	function index($id) {
		...
		//$this->langModule	=	strtolower($language->name);
		...
		//echo $this->data['page_content'];die;
		...
		$this->render_admin('language/translateLang', $this->data);	
	}
