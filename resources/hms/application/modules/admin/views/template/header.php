...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/admin')?>/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
   <?php if($this->session->userdata('direction')== 'rtl') { ?>
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url('assets/admin')?>/dist/css/AdminLTE-rtl.min.css">
  <link rel="stylesheet" href="<?php echo base_url('assets/admin')?>/dist/css/skins/_all-skins-rtl.min.css">
  <?php } else {?>
   <!-- Theme style -->
